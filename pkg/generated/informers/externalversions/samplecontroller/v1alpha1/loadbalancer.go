...
import (
	...
	samplecontrollerv1alpha1 "github.com/sample-controller/pkg/apis/samplecontroller/v1alpha1"
	versioned "github.com/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/sample-controller/pkg/generated/listers/samplecontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Loadbalancers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Loadbalancers(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecontrollerv1alpha1.Loadbalancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadbalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1alpha1.Loadbalancer{}, f.defaultInformer)
}
