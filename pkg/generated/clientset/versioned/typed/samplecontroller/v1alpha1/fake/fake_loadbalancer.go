...
import (
	...
	v1alpha1 "github.com/sample-controller/pkg/apis/samplecontroller/v1alpha1"
...
var loadbalancersResource = schema.GroupVersionResource{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Resource: "loadbalancers"}

var loadbalancersKind = schema.GroupVersionKind{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Kind: "Loadbalancer"}
